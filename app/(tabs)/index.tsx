    ...
    <ScrollView className={""}>
        <View className={"flex flex-col gap-5 items-center justify-center"}>
            <View className={"mt-4 flex-row h-20 items-center justify-center"}>
                <AntDesign on className={"pr-3"} name="left" size={26} color="black" />
            ...
            <View className={" z-50 border border-black h-[9rem] w-[27rem] rounded-2xl items-center justify-center"} >
            ...
            <View className={"py-2 flex flex-col px-8 border border-bg2 rounded-xl w-[27rem] items-center justify-center"}>
            ...
            <View className={"flex flex-col px-8 border border-bg2 rounded-xl w-[27rem]"}>
